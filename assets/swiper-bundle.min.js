var Swiper = (function () {
    ...
    updateSlides: function () {
      ...
      if (l && s.loop) {
        ...
        for (let i = 0; i < e.virtual.slidesBefore + e.virtual.slidesAfter; i += 1)
          1 === s.slidesPerGroup && h.push(h[h.length - 1] + t), m.push(m[m.length - 1] + t), (e.virtualSize += t);
      }
      ...
      if (
        (Object.assign(e, { slides: c, snapGrid: h, slidesGrid: m, slidesSizesGrid: g }),
  ...
  var G = {
    slideTo: function (e, t, s, i, r) {
      ...
      if (n.initialized && a !== p) {
        if (
          !n.allowSlideNext &&
          (f ? w > n.translate && w > n.minTranslate() : w < n.translate && w < n.minTranslate())
        )
          return !1;
    ...
    slideToLoop: function (e, t, s, i) {
      ...
      if (r.params.loop)
        if (r.virtual && r.params.virtual.enabled) a += r.virtual.slidesBefore;
          ...
          let l = t - e < o;
          if (
            (s && (l = l || e < Math.ceil(o / 2)), i && s && 'auto' !== r.params.slidesPerView && !n && (l = !1), l)
          ) {
            const i = s
              ? e < r.activeIndex
                ? 'prev'
  ...
  var D = {
    ...
    loopFix: function (e) {
      ...
      'auto' === v
        ...
        : ((v = Math.ceil(parseFloat(f.slidesPerView, 10))), m && v % 2 == 0 && (v += 1));
      ...
      d.length < v + w
        ...
        : S && 'row' === f.grid.fill && h('Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`');
      const T = [],
        b = [];
      let y = l.activeIndex;
      void 0 === n ? (n = l.getSlideIndex(d.filter((e) => e.classList.contains(f.slideActiveClass))[0])) : (y = n);
      const x = 'next' === i || !i,
        E = 'prev' === i || !i;
      let M = 0,
        P = 0;
  ...
  function N(e) {
    ...
    if ('touchmove' === p.type) {
      if (((c = [...p.changedTouches].filter((e) => e.identifier === r.touchId)[0]), !c || c.identifier !== r.touchId))
        return;
    } else c = p;
    ...
    if (!s.allowTouchMove)
      return (
        ...
        void (
          r.isTouched &&
          (Object.assign(a, { startX: u, startY: f, currentX: u, currentY: f }), (r.touchStartTime = o()))
        )
      );
    ...
    if (
      ...
      return (
        Object.assign(a, { startX: u, startY: f, currentX: u, currentY: f, startTranslate: r.currentTranslate }),
        (r.loopSwapReset = !0),
      ...
      v > 0
        ? (S &&
          ...
          r.currentTranslate > s.minTranslate() &&
            ((b = !1),
            n.resistance &&
              (r.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + r.startTranslate + v) ** y)))
        : v < 0 &&
          (S &&
            T &&
            r.allowThresholdMove &&
            ...
            s.loopFix({
              ...
              activeSlideIndex:
                s.slides.length -
                ('auto' === n.slidesPerView ? s.slidesPerViewDynamic() : Math.ceil(parseFloat(n.slidesPerView, 10))),
            }),
          r.currentTranslate < s.maxTranslate() &&
            ((b = !1),
            n.resistance &&
              (r.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - r.startTranslate - v) ** y))),
  ...
  const W = (e, t) => {
    ...
    n &&
      ...
      r.updateOnWindowResize
        ? e[c](o.ios || o.android ? 'resize orientationchange observerUpdate' : 'resize observerUpdate', F, !0)
      ...
      transition: {
        ...
        transitionStart: function (e, t) {
          ...
          const s = this,
            { params: i } = s;
          i.cssMode ||
            (i.autoHeight && s.updateAutoHeight(), z({ swiper: s, runCallbacks: e, direction: t, step: 'Start' }));
        },
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          const h = o.direction && o.direction !== i.direction,
            ...
            v = i.loop;
          h && s && e.changeDirection(), c(e.params, o);
